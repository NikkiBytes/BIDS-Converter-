...
# @Authors: Grace Shearrer, Nichollete Acosta
# @Title: Setup subjects  for BIDS conversion
# @Description: This script works with the osirix_scrape.py -- using the subject id from the Scraper
#               we gather the dicoms and place them into a raw file using this script.
